      ...
      <div class="col-lg-6  main-body">
        ...
        <div class="profileContent">
          ...
          <div id="content">
            ...
            <div id="pform">
              <form method="post" action="{{ url('education-occupation')}}" name="profileForm" id="profileForm" class="needs-validation" novalidate>
                  @csrf
                ...
                <div class="form-group d-flex justify-content-start">
                  ...
                  <div class="col">
                    <div class="row">
                      <div class="col">
                        <input type="radio" class="w-auto" name="employed" value="Government" {{ ($education->employed??'NA') == 'Government' ? 'Checked': ''}} required>
                        <label class="labelradiobtn">Government</label>
                        <input type="radio" class="w-auto" name="employed" value="Defence" {{ ($education->employed ??'' == 'Defence') ? 'Checked': ''}} required>
                        <label class="labelradiobtn">Defence</label>
                        <input type="radio" class="w-auto" name="employed" value="Private" {{ ($education->employed??'' == 'Private') ? 'Checked': ''}} required>
                        <label class="labelradiobtn">Private</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col">
                        <input type="radio" class="w-auto" name="employed" value="Business"{{ ($education->employed??'' == 'Business') ? 'Checked': '' }} required>
                        <label class="labelradiobtn">Business</label>
                        <input type="radio" class="w-auto" name="employed" value="Self Employed"{{ ($education->employed??'' == 'Self Employed') ? 'Checked': '' }} required>
                        <label class="labelradiobtn">Self Employed</label>
                        <input type="radio" class="w-auto" name="employed" value="Not Working"{{ ($education->employed??'' == 'Not Working') ? 'Checked': '' }} required>
                ...
                <div class="form-group d-flex justify-content-start">
                  ...
                  <div class="col">
                    <select id="Occupation" name="annual_income" class="form-control" required>
                      ...
                      <option {{ (($education->annual_income ??'') == 'NA') ? 'selected' : '' }} value="NA">NA</option>
                      <option {{ (($education->annual_income ??'') == 'Upto INR 1 Lakh') ? 'selected' : ''  }} value="Upto INR 1 Lakh">Upto INR 1 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 1 Lakh to 2 Lakh') ? 'selected' : ''  }} value="INR 1 Lakh to 2 Lakh">INR 1 Lakh to 2 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 2 Lakh to 4 Lakh') ? 'selected' : ''  }} value="INR 2 Lakh to 4 Lakh">INR 2 Lakh to 4 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 4 Lakh to 7 Lakh') ? 'selected' : ''  }} value="INR 4 Lakh to 7 Lakh">INR 4 Lakh to 7 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 7 Lakh to 10 Lakh') ? 'selected' : ''  }} value="INR 7 Lakh to 10 Lakh">INR 7 Lakh to 10 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 10 Lakh to 1 Lakh') ? 'selected' : ''  }} value="INR 10 Lakh to 15 Lakh">INR 10 Lakh to 15 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 15 Lakh to 20 Lakh') ? 'selected' : ''  }} value="INR 15 Lakh to 20 Lakh">INR 15 Lakh to 20 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 20 Lakh to 30 Lakh') ? 'selected' : ''  }} value="INR 20 Lakh to 30 Lakh">INR 20 Lakh to 30 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 30 Lakh to 50 Lakh') ? 'selected' : ''  }} value="INR 30 Lakh to 50 Lakh">INR 30 Lakh to 50 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 50 Lakh to 75 Lakh') ? 'selected' : ''  }} value="INR 50 Lakh to 75 Lakh">INR 50 Lakh to 75 Lakh</option>
                      <option {{ (($education->annual_income ??'') == 'INR 75 Lakh to 1 Crore') ? 'selected' : ''  }} value="INR 75 Lakh to 1 Crore">INR 75 Lakh to 1 Crore</option>
                      <option {{ (($education->annual_income ??'') == 'INR 1 Crore & above') ? 'selected' : ''  }} value="INR 1 Crore & above">INR 1 Crore & above</option>
                    </select>
