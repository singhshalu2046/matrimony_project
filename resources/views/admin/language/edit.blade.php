            ...
            <div class="card" id="customerList">
                <div class="card-header border-bottom-dashed">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                <h5 class="card-title mb-0">Language Edit</h5>
                            </div>
                        </div>
                ...
                {{-- {{ dd($language) }} --}}
                  <form method="POST" action="{{ route("admin.language.update", [$language->id]) }}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $language->name) }}" step="1" required>
                          @if($errors->has('name'))
