...
var customerList = new List("customerList", options).on("updated", function (list) {
  ...
  if(list.matchingItems.length == 0  && document.getElementsByClassName("noresult")[0]) {
    (document.getElementsByClassName("noresult")[0].style.display = "block") 

  }else if(document.getElementsByClassName("noresult")[0]){
...
if(document.getElementsByClassName("noresult")[0]){
...
if(isCount){
if(isCount.body.firstElementChild > 0){
  var isValue = sCount.body.firstElementChild.innerHTML;
};
}
