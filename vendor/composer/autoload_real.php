...
class ComposerAutoloaderInit2b936527ea258a6429e2f86002f9ffcc
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit2b936527ea258a6429e2f86002f9ffcc::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire2b936527ea258a6429e2f86002f9ffcc($fileIdentifier, $file);
        }
...
function composerRequire2b936527ea258a6429e2f86002f9ffcc($fileIdentifier, $file)
{
